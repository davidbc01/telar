...
const PALABRAS_CLAVE: Record<string, TipoToken> = {
    ...
    "según": TipoToken.Segun,
    "segun": TipoToken.Segun,
    "por": TipoToken.Por,
    ...
    "ir": TipoToken.Ir,
    "suma": TipoToken.Suma,
    "resta": TipoToken.Resta,
    "alterna": TipoToken.Alterna,
    ...
    "diseño": TipoToken.Diseno,
    "diseno": TipoToken.Diseno,
    "componente": TipoToken.Componente,
    "con": TipoToken.Con,
    "requerido": TipoToken.Requerido,
    "mínimo": TipoToken.Minimo,
    "minimo": TipoToken.Minimo,
    "variable": TipoToken.Variable,
    "texto": TipoToken.PalabraTexto,
    "tema": TipoToken.Tema,
    "imagen": TipoToken.Imagen,
